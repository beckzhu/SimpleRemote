...
namespace SimpleRemote.Bll
{
    public static class Update
    {
        ...
        /// <summary>本地更新日期</summary>
        public static DateTime LocalUpdated { get; } = new DateTime(2019, 5, 4);
        ...
        /// <summary>下载最新版本</summary>
        public static async Task Download()
        {
            string zipFile = Path.Combine(UserSettings.AppdDataDir, "Update.zip");
